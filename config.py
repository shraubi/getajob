...
HIRIFY_STATE_PATH = Path(os.environ.get("HIRIFY_STATE_PATH", "storage/hirify_state.json"))
HIRIFY_BROWSER_EXECUTABLE = os.environ.get("HIRIFY_BROWSER_EXECUTABLE", "/usr/bin/chromium")
